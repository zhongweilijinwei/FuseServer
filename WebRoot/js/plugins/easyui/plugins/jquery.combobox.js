...
(function($) {
	...
	function _1a(_21, _22, _23) {
		...
		_25.find("div.combobox-item-selected").removeClass(
		...
		for ( var i = 0; i < _28.length; i++) {
			...
			if (g) {
				if (_2d != g) {
					...
					dd
							.push("<div id=\""
									+ (_2a.groupIdPrefix + "_" + (_2a.groups.length - 1))
									+ "\" class=\"combobox-group\">");
					dd.push(_2b.groupFormatter ? _2b.groupFormatter
							.call(_27, g) : g);
					dd.push("</div>");
				}
			} else {
			...
			var cls = "combobox-item"
					...
					+ (g ? " combobox-gitem" : "");
			dd.push("<div id=\"" + (_2a.itemIdPrefix + "_" + i) + "\" class=\""
					+ cls + "\">");
	...
	function _34(_35, q) {
		...
		if (_37.mode == "remote") {
			...
			_39.find("div.combobox-item-selected,div.combobox-item-hover")
			...
			if (_4e) {
				...
				_4e = $.data(this, "combobox", {
					options : $.extend({}, $.fn.combobox.defaults,
							$.fn.combobox.parseOptions(this), _4b),
					data : []
				});
			}
			_44(this);
	...
	$.fn.combobox.methods = {
		...
		clear : function(jq) {
			return jq.each(function() {
				...
				_53.find("div.combobox-item-selected").removeClass(
						"combobox-item-selected");
			});
		},
		reset : function(jq) {
	...
	$.fn.combobox.parseOptions = function(_59) {
		var t = $(_59);
		return $.extend({}, $.fn.combo.parseOptions(_59), $.parser
				.parseOptions(_59, [ "valueField", "textField", "groupField",
						"mode", "method", "url" ]));
	};
	$.fn.combobox.parseData = function(_5a) {
		...
		function _5e(el, _5f) {
			var t = $(el);
			var row = {};
			row[_5c.valueField] = t.attr("value") != undefined ? t
					.attr("value") : t.text();
	...
	$.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults,
			{
				...
				filter : function(q, row) {
					...
					return row[_61.textField].toLowerCase().indexOf(
							q.toLowerCase()) == 0;
				},
				...
				finder : {
					getEl : function(_69, _6a) {
						var _6b = _2(_69, _6a);
						var id = $.data(_69, "combobox").itemIdPrefix + "_"
								+ _6b;
						return $("#" + id);
					},
					getRow : function(_6c, p) {
						var _6d = $.data(_6c, "combobox");
						var _6e = (p instanceof jQuery) ? p.attr("id").substr(
								_6d.itemIdPrefix.length + 1) : _2(_6c, p);
