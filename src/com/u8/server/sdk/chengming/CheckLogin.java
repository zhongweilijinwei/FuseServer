...
public class CheckLogin {
	 ...
	 * .................
	 */
	public static String ReqData(String appid, String logintoken,String privatekey) {
		JSONObject jsonObject = new JSONObject();
		jsonObject.put("appid", appid);
		jsonObject.put("logintoken", logintoken);
		String content = jsonObject.toString();// 组装成 json格式数据
		String sign = SignHelper.sign(content, privatekey);// 调用签名函数
	...
	// 令牌验证
	public static boolean CheckToken(String url,String appid, String logintoken,String privatekey,String publickey) {
		String reqData = ReqData(appid, logintoken,privatekey);
		String respData = HttpUtils.sentPost(url,reqData,"UTF-8"); // 请求验证服务端
