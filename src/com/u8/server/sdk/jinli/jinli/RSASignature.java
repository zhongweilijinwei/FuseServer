...
public class RSASignature {
	...
	public static boolean doCheck(String content, String sign, String publicKey, String encode)
		...
		byte[] encodedKey = com.u8.server.sdk.jinli.jinli.Base64.decode(publicKey);
		...
		boolean bverify = signature.verify(com.u8.server.sdk.jinli.jinli.Base64.decode(sign));
		return bverify;
