...
//    private static final String AUTH_URL = "http://14.23.156.2:8089/YTServer/user/verifyAccount";
  private static final String AUTH_URL = "http://14.152.59.179:8080/APYXServer/user/verifyAccount";//线上版本
//	private static final String AUTH_URL = "http://14.152.59.179:8082/APYXServer/user/verifyAccount";//线上backup版本
    ...
    public void getChannel(){
    	...
    	String login = "aipai";
    	String pay = "heishi";
        Log.d("getLoginChannel");
        JSONObject jsonObject = new JSONObject();
        JSONObject contentjsn = new JSONObject();
        
        JSONObject loginsdknamejsn = new JSONObject();
        JSONObject loginnamejsn = new JSONObject();
        
        JSONObject paysdknamejsn = new JSONObject();
        JSONObject paynamejsn = new JSONObject();
        
        loginsdknamejsn.put("sdkName", login);
//        loginnamejsn.put("loginChannel", loginsdknamejsn);
        
        paysdknamejsn.put("sdkName", pay);
//        paynamejsn.put("payChannel", paysdknamejsn);
        
        contentjsn.put("loginChannel", loginsdknamejsn);
        contentjsn.put("payChannel", paysdknamejsn);

        jsonObject.put("content", contentjsn);
        renderState2(200, jsonObject);
    }
    
    private void renderState2(int state, JSONObject data){
        try{

        	data.put("state", state);

            super.renderJson(data.toString());
